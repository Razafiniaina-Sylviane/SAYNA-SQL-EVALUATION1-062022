...
(2,'Bérénice','Jean RACINE', 1670, 'Th��tre'),
(3,'Prolégomènes �  toute métaphysique future','Emmanuel KANT', 1783, 'Philosophie'),
(4,'Mon coeur mis � nu','Charles BAUDELAIRE', 1887, 'Journal'),
...
(10,'Lettres de Gourgounel','Kenneth WHITE', 1979, 'R�cit'),
(11,'Lettres � un jeune poète','Rainer Maria RILKE', 1929, 'Lettre'),
(12,'Logique sans peine','Lewis CAROLL', 1887, 'Logique'),
(13,'L''éthique','Baruch SPINOZA', 1677, 'Philosophie'),
(14,'Sur le r�ve','Sigmund FREUD', 1900, 'Philosophie'),
(15,'Sens et dénotation','Gottlob FREGE', 1892, 'Philosophie'),
(16,'Penser la logique','Gilbert HOTTOIS', 1989, 'Philosophie'),
(17,'Au coeur des t�n�bres','Joseph CONRAD',1899, 'Roman'),
